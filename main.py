...
LLAMA_API_KEY = "YOUR_LLAMA_API_KEY"  # Add your API key here
...
GEMINI_API_KEY = "YOUR_GEMINI_API_KEY"  # Add your API key here
...
if st.button("Start Conversation"):
    ...
    for i in range(rounds):
        ...
        gemini_personality = "Wow, great insights," + " " + gemini_response
        st.markdown(f"{gemini_icon} <span style='color:yellow'>Gemini:</span> {gemini_personality}", unsafe_allow_html=True)
        st.session_state["conversation_history"].append({"agent": "Gemini", "icon": gemini_icon, "response": gemini_personality})
        time.sleep(10)
